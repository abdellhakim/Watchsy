      ...
      <div className="flex">
        ...
        <div className="w-2/3 p-4">
          ...
          <div className="flex items-center justify-between mt-4">
            <button onClick={() => setExpanded(!expanded)} className="text-sm text-blue-400 cursor-pointer hover:underline">{expanded ? 'Hide details' : 'Show details'}</button>
            <button onClick={() => onMarkAsWatched(item.id, isTvShow)} className="flex items-center cursor-pointer gap-2 bg-red-600 hover:bg-red-700 px-3 py-1 rounded-md text-sm">
              <Check size={16} />
